...
var data = [
  ...
  simple use:
  <BasicPie id="chart1" data={data} xAxisName={xAxisName}/>
 
  Advance use:
  <BasicPie id="test" title="曲线测试" subtitle="这是一个副标题测试" height="800px" width="100%" trigger="item" theme="macarons" data={data} xAxisName={xAxisName} smooth={true}/>
```
 */
